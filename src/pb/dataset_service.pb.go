...
const file_dataset_service_proto_rawDesc = "" +
	"\n" +
	"\x15dataset_service.proto\x12\x0fdataset_service\"\x93\x01\n" +
	...
	"\x0eDatasetService\x12T\n" +
	"\rStreamBatches\x12%.dataset_service.StreamBatchesRequest\x1a\x1a.dataset_service.DataBatch0\x01\x12H\n" +
	"\bGetBatch\x12 .dataset_service.GetBatchRequest\x1a\x1a.dataset_service.DataBatch\x12V\n" +
